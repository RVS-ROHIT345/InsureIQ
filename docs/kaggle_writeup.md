...
**InsureIQ** accepts any insurance document (PDF or DOCX) and runs it through a chain of
six specialized agents, producing a plain-English analysis and a fully formatted `.docx`
report covering:
